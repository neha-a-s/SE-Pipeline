# -*- coding: utf-8 -*-
"""Pneumonia_model4_clahe_11may_diffeps_pgd_seg.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qgneJIfBDkhZo-ebML6ev-T0_XLa1QdU
"""
...
!unzip /content/drive/MyDrive/Research_workarea/xray_pneumonia/xray_pneumonia_segmented_new.zip

# DIR = open('/content/xray_pneumonia','r')
# print(DIR)

train_folder = '/content/content/xray_pneumonia_segmented/train'
test_folder ='/content/content/xray_pneumonia_segmented/test'
val_folder ='/content/content/xray_pneumonia_segmented/val'
...
for i in range(len(image_probs_adv)):
  image_probs_adv1.append(np.array(image_probs_adv[i][0]))
